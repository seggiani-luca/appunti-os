...
\begin{enumerate}
	...
	\item \textbf{Attesa circolare}: esiste un insieme $\{p_0, p_1, ..., p_n \}$ di processi in attesa tali che $p_0$ aspetta una risorsa di $p_1$, $p_1$ aspetta una risorsa di $p_2$, ..., $p_{n - 1}$ aspetta una risorsa di $p_n$ e $p_n$ aspetta una risorsa di $p_1$.
\end{enumerate}
