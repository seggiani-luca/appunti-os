...
\begin{itemize}
	...
	\item Potremmo permettere al sistema in normale operazione di trovarsi in stato di deadlock, rilevare tale deadlock e iniziare delle procedure di recupero: questo è il modello di \textbf{deadlock detection} e \textbf{avoidance} (\textit{prevenzione dinamica}).
